 ...
 */
public abstract class Hilt_HungryFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_HungryFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HungryFragment_GeneratedInjector) this.generatedComponent()).injectHungryFragment(UnsafeCasts.<HungryFragment>unsafeCast(this));
    }
  }
